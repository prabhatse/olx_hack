...
<!-- Graph CSS -->
<link href="{$site_root_path}assets/css/lines.css" rel='stylesheet' type='text/css' />
...
<!---//webfonts--->  
<!-- Nav CSS -->
<link href="{$site_root_path}assets/css/custom.css" rel="stylesheet">
<!-- Metis Menu Plugin JavaScript -->
<script src="{$site_root_path}assets/js/metisMenu.min.js"></script>
<script src="{$site_root_path}assets/js/custom.js"></script>
<!-- Graph JavaScript -->
<script src="{$site_root_path}assets/js/d3.v3.js"></script>
<script src="{$site_root_path}assets/js/rickshaw.js"></script>
</head>
<body>
<div id="wrapper">
     <!-- Navigation -->
       
        	{include file="_leftSideBar.tpl"}
            <!-- sidebar TPL goes here -->
		       ...
		       <div class="activity_box">
		        <div class="scrollbar" id="style-2">
                   <div class="activity-row">
	                 ...
	                 <div class="col-xs-3 activity-img"><img src='{$site_root_path}assets/images/5.png' class="img-responsive" alt=""/></div>
	                 ...
	                 <div class="col-xs-3 activity-img"><img src='{$site_root_path}assets/images/3.png' class="img-responsive" alt=""/></div>
	                 <div class="col-xs-8 activity-desc">
                    ...
                    <div class="activity-row">
	                 ...
	                 <div class="col-xs-3 activity-img"><img src='{$site_root_path}assets/images/1.png' class="img-responsive" alt=""/></div>
	                 <div class="col-xs-8 activity-desc">
                    ...
                    <div class="activity-row1">
	                 ...
	                 <div class="col-xs-3 activity-img"><img src='{$site_root_path}assets/images/4.png' class="img-responsive" alt=""/></div>
	                 <div class="col-xs-8 activity-desc">
...
{/literal}
	      ...
	      <!-- map -->
<link href="{$site_root_path}assets/css/jqvmap.css" rel='stylesheet' type='text/css' />
<script src="{$site_root_path}assets/js/jquery.vmap.js"></script>
<script src="{$site_root_path}assets/js/jquery.vmap.sampledata.js" type="text/javascript"></script>
<script src="{$site_root_path}assets/js/jquery.vmap.world.js" type="text/javascript"></script>
{literal}
