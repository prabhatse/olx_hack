<?php /* Smarty version 2.6.28, created on 2015-09-26 12:45:32
...
<!-- Graph CSS -->
<link href="<?php echo $this->_tpl_vars['site_root_path']; ?>
assets/css/lines.css" rel='stylesheet' type='text/css' />
<link href="<?php echo $this->_tpl_vars['site_root_path']; ?>
...
<!-- Graph JavaScript -->
<script src="<?php echo $this->_tpl_vars['site_root_path']; ?>
assets/js/d3.v3.js"></script>
<script src="<?php echo $this->_tpl_vars['site_root_path']; ?>
assets/js/rickshaw.js"></script>
</head>
<body>
<div id="wrapper">
     <!-- Navigation -->
        	...
        	<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "_leftSideBar.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
		       ...
		       <div class="activity_box">
		        <div class="scrollbar" id="style-2">
                   <div class="activity-row">
	                 ...
	                 <div class="col-xs-3 activity-img"><img src='<?php echo $this->_tpl_vars['site_root_path']; ?>
assets/images/5.png' class="img-responsive" alt=""/></div>
	                 ...
	                 <div class="col-xs-3 activity-img"><img src='<?php echo $this->_tpl_vars['site_root_path']; ?>
assets/images/3.png' class="img-responsive" alt=""/></div>
	                 <div class="col-xs-8 activity-desc">
                    ...
                    <div class="activity-row">
	                 ...
	                 <div class="col-xs-3 activity-img"><img src='<?php echo $this->_tpl_vars['site_root_path']; ?>
assets/images/1.png' class="img-responsive" alt=""/></div>
	                 <div class="col-xs-8 activity-desc">
                    ...
                    <div class="activity-row1">
	                 ...
	                 <div class="col-xs-3 activity-img"><img src='<?php echo $this->_tpl_vars['site_root_path']; ?>
assets/images/4.png' class="img-responsive" alt=""/></div>
	                 <div class="col-xs-8 activity-desc">
...
'; ?>
	      ...
	      <!-- map -->
<link href="<?php echo $this->_tpl_vars['site_root_path']; ?>
assets/css/jqvmap.css" rel='stylesheet' type='text/css' />
<script src="<?php echo $this->_tpl_vars['site_root_path']; ?>
assets/js/jquery.vmap.js"></script>
<script src="<?php echo $this->_tpl_vars['site_root_path']; ?>
assets/js/jquery.vmap.sampledata.js" type="text/javascript"></script>
<script src="<?php echo $this->_tpl_vars['site_root_path']; ?>
assets/js/jquery.vmap.world.js" type="text/javascript"></script>
<?php echo '
    ...
    <div class="content_bottom">
     <div class="col-md-8 span_3">
	   ...
	   <div class="col-md-4 span_4">
		...
		<div class="copy">
            <p>Copyright &copy; 2015 Modern. All Rights Reserved | Design by <a href="<?php echo $this->_tpl_vars['site_root_path']; ?>
" target="_blank">EFC</a> </p>
	    </div>
		</div>
       </div>
      <!-- /#page-wrapper -->
